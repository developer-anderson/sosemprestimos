        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('clientes.emprestimos.create', ['id' => $clienteId]) }}" :active="request() - > routeIs('clientes')"
                                ...
                                <table class="min-w-full text-left text-sm font-light">
                                    <thead class="border-b font-medium dark:border-neutral-500">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-6 py-4">Atualizado em</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($emprestimos as $e)
                                            <tr
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $e->id }}
                                                </td>
                                                <td class="whitespace-nowrap px-6 py-4">{{ $e->valor }}</td>
                                                <td class="whitespace-nowrap px-6 py-4">{{ $e->status }}</td>
                                                <td class="whitespace-nowrap px-6 py-4">{{ $e->created_at }}</td>
                                                <td class="whitespace-nowrap px-6 py-4 flex">
                                                    <a href="{{ route('clientes.edit', ['id' => $e->id]) }}"
                                                    ...
                                                    <form action="{{ route('clientes.destroy', ['id' => $e->id]) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
