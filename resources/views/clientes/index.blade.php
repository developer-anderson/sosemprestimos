        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('clientes.create') }}" :active="request() - > routeIs('clientes')"
                                    ...
                                    <tbody>
                                        @foreach ($clientes as $c)
                                            <tr
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $c->id }}
                                                </td>
                                                <td class="whitespace-nowrap px-6 py-4">{{ $c->nome }}</td>
                                                <td class="whitespace-nowrap px-6 py-4">{{ $c->whatsapp }}</td>
                                                <td class="whitespace-nowrap px-6 py-4">{{ $c->email }}</td>
                                                <td class="whitespace-nowrap px-6 py-4 flex">
                                                    ...
                                                    <form action="{{ route('clientes.destroy', ['id' => $c->id]) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
