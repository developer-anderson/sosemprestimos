                ...
                <div class="flex flex-col p-6">
                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                            <form action="{{ route('clientes.update', ['id' => $clientes->id]) }}" class="w-full"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="w-full md:w-1/3 px-3">
                                        ...
                                        <input name="email"
                                            ...
                                            id="grid-email" type="email" value="{{ $clientes->email }}" placeholder=""
                                            required>
                                    </div>
                                    <div class="w-full md:w-1/3 px-3">
                                        <label
                                        ...
                                        <input name="whatsapp"
                                            ...
                                            id="grid-whatsapp" type="text" value="{{ $clientes->whatsapp }}"
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-3">
                                        ...
                                        <input name="cep"
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="grid-cep" type="text" value="{{ $clientes->cep }}" placeholder="">
                                    </div>
                                    ...
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-3">
                                        ...
                                        <input name="logradouro"
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="grid-logradouro" type="text" value="{{ $clientes->logradouro }}"
                                            placeholder="">
                                    </div>
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-3">
                                        <label
                                        ...
                                        <input name="numero"
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="grid-numero" type="text" value="{{ $clientes->numero }}"
                                            placeholder="">
                                    </div>
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-3">
                                        <label
                                        ...
                                        <input name="bairro"
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="grid-bairro" type="text" value="{{ $clientes->bairro }}"
                                            placeholder="">
                                    </div>
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-3">
                                        <label name="cidade"
                                        ...
                                        <input name="cidade"
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="grid-cidade" type="text" value="{{ $clientes->cidade }}"
                                            placeholder="">
                                    </div>
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-3">
                                        <label name="estado"
                                        ...
                                        <div class="relative">
                                            <select name="estado"
                                                ...
                                                <option value="{{ $clientes->estado }}">{{ $clientes->estado }}
                                                </option>
                                    ...
                                    <div class="w-full md:w-3/3 px-3 mb-6 md:mb-3">
                                        ...
                                        <textarea name="observacoes" id="observacoes" rows="4"
                                            class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            placeholder="">{{ $clientes->observacoes }}</textarea>
